...
export default function JogoDoBichoScreen() {
  ...
  return (
    <View style={styles.container}>
      <Button mode="contained" buttonColor="#000000" textColor="#ffffff" onPress={gerarAnimal}>Gerar Animal</Button>
      {animalGerado && (
...
const styles = StyleSheet.create({
  ...
  card: { marginTop: 16, alignItems: 'center', backgroundColor: '#f0f0f0' },
